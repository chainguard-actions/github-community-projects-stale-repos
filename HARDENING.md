...
Action **github-community-projects--stale-repos/v9.0.11** was hardened automatically. 1 finding(s) were identified and resolved across 1 iteration(s).
...
Pinned the Docker image reference in action.yml from `ghcr.io/github-community-projects/stale_repos:v9` to `ghcr.io/github-community-projects/stale_repos@sha256:f2ca313765e6ac6d54c2d17cb669c0b40a9bcbdf385c8ad91b0eb773bb2da0fd` with `# v9` comment for readability.
